...
Create a new **WebService.js** file and add the following code to try out some basic CRUD
...
Add to **WebService.js** the following function which uses the **insertMany**
...
Run the updated **WebService.js** file:
